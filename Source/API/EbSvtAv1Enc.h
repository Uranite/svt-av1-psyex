...
#if CLN_LP_LVLS
    uint8_t padding[128 - 5 * sizeof(Bool) - 14 * sizeof(uint8_t) - sizeof(int8_t) - sizeof(uint32_t) - sizeof(double)];
#else
    uint8_t padding[128 - 5 * sizeof(Bool) - 14 * sizeof(uint8_t) - sizeof(int8_t) - sizeof(double)];
#endif
